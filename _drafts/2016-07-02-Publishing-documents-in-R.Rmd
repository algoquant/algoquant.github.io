...
There are two different frameworks for publishing *R* documents: the first is the older *Sweave* framework, and the second is the newer *R Markdown* framework. There are two types of *R* documents: *Sweave* files and *R Markdown* files.
